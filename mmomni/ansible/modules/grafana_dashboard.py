...
# This module includes some small modifications done by Jesús Espino, to make it work with the current ansible version (2.9)
...
def grafana_create_dashboard(module, data):
    ...
    if dashboard_exists is True:
        # Modified for Omnibus: do not modified if exists
        result['uid'] = uid
